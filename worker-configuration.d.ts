// Generated by Wrangler by running `wrangler types` (hash: 256db12d771cdbff46a34274a606976c)
// Runtime types generated with workerd@1.20250320.0 2024-11-27 nodejs_compat
declare namespace Cloudflare {
	interface Env {
		CACHE_KV: KVNamespace;
		PAGE_TITLE: "Pineapple Gallery";
		DESCRIPTION: "Pineapple Gallery is a project designed to serve up image galleries using Cloudflare!";
		COPYRIGHT: "Pineapple Gallery";
